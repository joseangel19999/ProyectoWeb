   ...
   methods:{
       ...
       Activar:function(activo,id){
        ...
        CosultaDatos:function(){
            ...
            this.ListaE=datafromlocal;
            var i=this.ListaE.length;
            alert("tama "+i+ " datos "+ this.ListaE[0].CorreoR);
            console.log(this.ListaE);
            //this.Anombre=datafromlocal.CorreoR;
            //alert("llego "+this.Anombre);*/
           /* let formato= new FormData();
            let serverurl="jsaxios/taxista/CrudProd.php";
            let _this=this;
            ...
            axios.post(serverurl,formato).then(function(response){
                ...
                //alert("dato "+response.data[0].vchApellidosP);
            /*_this.ListaTaxista=response.data;
