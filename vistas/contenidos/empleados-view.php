		...
		<div class="container-fluid">
			<ul class="breadcrumb breadcrumb-tabs">
			  	<li>
			  		...
			  		<a href="<?php echo serverurl; ?>empleados" class="btn botones" >
			  			<i class="zmdi zmdi-plus ico"></i> &nbsp;NUEVO
			  		</a>
			  	</li>
			  	<li>
			  		<a href="<?php echo serverurl; ?>empleadolist" class="btn botones" >
				    	...
				    	<fieldset>
				    		<div class="container-fluid">
				    			<div class="row">
									...
									<div class="col-xs-12 col-sm-4">
								    	<div class="form-group label-floating">
										  	<label class="control-label">Nombre Socursal</label>
				    				...
				    				<div class="col-xs-12 col-sm-4">
										<div class="form-group label-floating">
										  	...
										  	<input pattern="[0-9+]{1,15}" v-model="Empleado[3]" class="form-control"  type="text" name="Telefono" maxlength="10">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-4">
										<div class="form-group label-floating">
										  	<label class="control-label">Correo</label>
										  	<input class="form-control" v-model="Empleado[4]" name="Direccion" rows="1" maxlength="30">
										</div>
				    				</div>
									<div >
									<br><br>
...
<script type="module" src="jsaxios/empleado/Ope_vueEmpleado.js"></script>