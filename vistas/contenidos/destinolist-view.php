<div class="container-fluid">
		<div class="page-header">
			<div class="text-t full-box text-uppercase">CATALOGO DESTINO DE PAQUETERIA</div>
			</div>
		</div>
		<div class="container-fluid">
		...
		<div class="container-fluid" id="AppProd">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="zmdi zmdi-format-list-bulleted ico"></i> &nbsp; LISTA DESTINOS PAQUETERIA</h3>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
						<table class="table table-hover text-center">
							...
							<tbody>
								<tr v-for="(destino,index) in DestinoLista">
									<td>{{destino.vchNomDestino}}</td>
									<td>$: {{destino.fltPrecio}}.00</td>
									<td>{{destino.vchDescripcion}}</td>
									<td>
									...
									<td>
											<button  v-on:click="Eliminar(destino.chClaveDestino)"    class="btn btn-danger btn-raised btn-xs">
...
<script src="jsaxios/destino/Ope_listEmple.js"></script>