...
<div class="container-fluid">
	<div class="page-header">
		<div class="text-t full-box text-uppercase">CATALOGO TIPO PAQUETE</div>
	</div>
</div>
	...
	<div class="container-fluid">
		<div class="panel panel-info">
			<div class="panel-heading">
				<h3 class="panel-title"><i class="zmdi zmdi-plus ico"></i> &nbsp;MODIFICAR TIPO PAQUETE</h3>
			</div>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-4">
									<div class="form-group label-floating">
										<label>DNI</label>
										<input pattern="[0-9-]{1,30}" v-model="Id" class="form-control" type="text" name="Id" required="" maxlength="30"  disabled=»disabled»/>
									</div>
								</div>
								<div class="col-xs-12 col-sm-4">
									<div class="form-group label-floating">
...
<script type="module" src="jsaxios/tipopaquete/Ope_empleModi.js"></script>