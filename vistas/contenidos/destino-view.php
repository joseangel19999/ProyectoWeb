		...
		<div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="zmdi zmdi-plus ico"></i> &nbsp;NUEVO DESTINO DE PAQUETERIA</h3>
				</div>
				    	...
				    	<fieldset>
				    		<div class="container-fluid">
				    			<div class="row">
									...
									<div class="col-xs-12 col-sm-4">
								    	<div class="form-group label-floating">
										  	<label class="control-label">Nombre Destino</label>
...
<script type="module" src="jsaxios/destino/Ope_vueEmpleado.js"></script>