							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-4">
									<div class="form-group label-floating">
										...
										<input pattern="[0-9+]{1,15}" v-model="Telefono" class="form-control" type="text" name="telefono-reg" maxlength="15">
									</div>
								</div>
								<div class="col-xs-12 col-sm-4">
									<div class="form-group label-floating">
										<label>Correo</label>
										<input name="direccion-reg" v-model="Correo" type="text"  class="form-control" rows="1" maxlength="100"></input>
									</div>
								</div>
							</div>
						</div>
