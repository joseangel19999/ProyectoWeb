								...
								<div class="col-xs-12 col-sm-3">
									...
									<div class="label-floating">
										...
										<select id="combo" name="CategoriaPuesto" class="col-xs-12 col-ms-6">
										    <option v-bind:value="idcate2">{{NomPuesto}}</option>
											<option value="cate.chIdPuesto" v-for="cate in ListaCate"  v-bind:value="cate.chIdPuesto ">{{cate.vchNomPuesto}}</option>
								...
								<div class="col-xs-12 col-sm-3">
									...
									<div class="label-floating">
										...
										<select id="comboArea" name="CategoriaArea" class="col-xs-12 col-ms-6">
											<option v-bind:value="IdCateArea" >{{nomCateArea}}</option>
											<option value="cate.chIdArea" v-for="cate in listaCateArea" v-bind:value="cate.chIdArea">{{cate.vchNomArea}}</option>
											<option >{{seleccione}}</option>
										</select>
									</div>
								</div>
