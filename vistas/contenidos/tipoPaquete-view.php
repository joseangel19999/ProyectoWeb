		...
		<div class="container-fluid">
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="zmdi zmdi-plus ico"></i> &nbsp;NUEVO TIPO DE PAQUETE</h3>
				</div>
				    	...
				    	<fieldset>
				    		<div class="container-fluid">
				    			<div class="row">
									...
									<div class="col-xs-12 col-sm-4">
								    	<div class="form-group label-floating">
										  	<label class="control-label">Nombre de tipo Paquete</label>
										  	<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" v-model="Empleado[1]" class="form-control" type="text" name="NombrePuesto" maxlength="30">
										</div>
									</div>
									<div class="col-xs-12 col-sm-4">
								    	<div class="form-group label-floating">
										  	<label class="control-label">Precio $</label>
										  	<input pattern="[0-9-]{1,30}" v-model="Empleado[2]" class="form-control" type="text" name="NombrePuesto" maxlength="30">
										</div>
				    				</div>
				    				<div class="col-xs-12 col-sm-8">
										<div class="form-group label-floating">
										  	<label class="control-label">Descripcion</label>
										  	<input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" v-model="Empleado[3]" class="form-control" type="text" name="Descripcion" maxlength="50">
										</div>
				    				</div>
				    			</div>
				    		</div>
...
<script type="module" src="jsaxios/tipopaquete/Ope_vueEmpleado.js"></script>